...
function App() {
  ...
  const startMusic = async () => {
    ...
    try {
      ...
      console.warn("Autoplay/music start blocked by browser:", error);
  ...
  useEffect(() => {
    // Tries to autoplay on page load. Some browsers block sound until user interaction.
    startMusic();
  ...
  return (
    <div className="site-shell">
      ...
      {autoplayBlocked && !musicPlaying && (
        <div className="music-hint">Tap anywhere or press Play to start music</div>
      )}
      ...
      >
        ...
        <strong>{musicPlaying ? "Pause Music" : "Play Music"}</strong>
      </button>
